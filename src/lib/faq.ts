export const faqItems = [
  {
    question: "Apa perbedaan Agent Basic dan Agent Pro?",
    answer:
      "Agent Basic cocok untuk analisis harian dengan fitur inti, sedangkan Agent Pro memberikan analisis saham lebih mendalam dan dashboard lanjutan.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Bisa. Anda dapat melakukan upgrade paket kapan saja agar mendapat akses fitur Agent Pro tanpa perlu membuat akun baru.",
  },
] as const;
