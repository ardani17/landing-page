    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          {plans.map((plan) => {
            const savingsValue = plan.regularPrice - plan.referralPrice;
            const savingsPercent = Math.round(
              (savingsValue / plan.regularPrice) * 100
            );
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 px-4 py-3">
                        ...
                        <p className="mt-1 text-2xl font-bold text-neutral-900 dark:text-white">
                          {formatRupiah(plan.regularPrice)}
                      ...
                      <div className="rounded-xl border border-vastara-red-300/70 dark:border-vastara-red-700/80 bg-gradient-to-br from-vastara-red-50 via-white to-vastara-red-100 dark:from-vastara-red-950 dark:via-[#23070A] dark:to-neutral-950 px-4 py-4 shadow-sm dark:shadow-[0_0_22px_rgba(220,38,38,0.22)]">
                        <div className="flex items-center justify-between gap-3">
                          <p className="text-xs uppercase tracking-wide text-vastara-red-700 dark:text-vastara-red-300">
                            Harga Referral Agen
                          </p>
                          <span className="inline-flex items-center rounded-full bg-vastara-red-600 dark:bg-vastara-red-500 dark:shadow-[0_0_14px_rgba(248,113,113,0.45)] px-2.5 py-1 text-[11px] font-semibold text-white">
                            Hemat {savingsPercent}%
                          </span>
                        </div>

                        <p className="mt-2 text-3xl font-semibold text-vastara-red-700 dark:text-vastara-red-300 dark:drop-shadow-[0_0_10px_rgba(248,113,113,0.55)]">
                          {formatRupiah(plan.referralPrice)}
                          <span className="text-sm font-medium text-vastara-red-700/80 dark:text-vastara-red-400">
                            {" "}
                            /bulan
                          </span>
                        </p>

                        <p className="mt-1 text-xs text-vastara-red-700/80 dark:text-vastara-red-300/95">
                          Potongan {formatRupiah(savingsValue)} dari harga normal
                        </p>
                      </div>
                    </div>
